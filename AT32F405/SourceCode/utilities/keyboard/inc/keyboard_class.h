...
#define USBD_HIDIAP_IN_EPT                    0x82
#define USBD_HIDIAP_OUT_EPT                   0x02
...
typedef struct
{
  ...
  uint8_t iap_rx[USBD_KEYBOARD_OUT_MAXPACKET_SIZE];
  uint8_t iap_tx[USBD_KEYBOARD_IN_MAXPACKET_SIZE];
  ...
  uint8_t g_rxhid_buff[USBD_KEYBOARD_OUT_MAXPACKET_SIZE];
